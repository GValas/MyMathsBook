...
\begin{mdframed}[style=proofbar]
  ...
  \]
  Le terme tout intégré tend vers $0$ quand $\varepsilon\to 0^+$ et
  $A\to+\infty$ (car $x>0$). En passant à la limite :
  \[
    \Gam(x+1) = x\,\Gam(x).
  \]
  ...
  =\tfrac{\sqrt{\pi}}{2}$ (elle-même limite des intégrales de Wallis). On en
...
\begin{mdframed}[style=exbar]
  ...
  $W_n=\intz \sin^n t\,\mathrm{d}t=\tfrac12 B\!\left(\tfrac{n+1}{2},\tfrac12\right)
   =\dfrac{\sqrt{\pi}}{2}\,\dfrac{\Gam\!\left(\frac{n+1}{2}\right)}
   {\Gam\!\left(\frac{n}{2}+1\right)}$,
  où $\displaystyle\intz=\int_0^{\pi/2}$.
