...
\begin{mdframed}[style=exbar]
  ...
  divergent (elles oscillent entre $\tfrac12$ et $0$) : la série n'est pas
  Cesàro-sommable. Elle est toutefois sommable par \emph{itération} du procédé :
  les moyennes des $\sigma_n$ convergent vers $\tfrac14$, ce qui en fait une
  somme $(C,2)$, de même valeur que la somme d'Abel. La hiérarchie
  $(C,1)\subsetneq(C,2)\subsetneq\cdots$ s'échelonne ainsi strictement entre la
  convergence et la sommation d'Abel.
...
\begin{mdframed}[style=cexbar]
  ...
  régulier (cf. la leçon sur la somme $1+2+3+\cdots=-\tfrac1{12}$).%
