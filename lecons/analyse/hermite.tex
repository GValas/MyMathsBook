%==============================================================
%  lecons/analyse/hermite.tex — Les polynômes de Hermite
%==============================================================

\lecontitle{Les polynômes de Hermite}{Analyse réelle — Polynômes orthogonaux et approximation}
...
\begin{tcolorbox}[thmbox]
  \textbf{Définition.}\enspace\index{polynômes de Hermite}
  ...
  \]
  on appelle \emph{$n$-ième polynôme de Hermite} (convention dite des
  ...
  \begin{itemize}
    ...
    \[
      ...
      \quad H_0=1,\ H_1=2X.
    \]
    \item \textit{Équation différentielle de Hermite}~:
    \[
      y'' - 2x\,y' + 2n\,y = 0,
    \]
...
Les polynômes de Hermite forment une \emph{base orthogonale} de l'espace
...
tout entier. Les fonctions $\psi_n(x)=H_n(x)\,e^{-x^2/2}$ — les
\emph{fonctions de Hermite} — sont les états propres de
...
\begin{mdframed}[style=exbar]
  ...
  Les fonctions de Hermite $\psi_n(x)=H_n(x)\,e^{-x^2/2}$ vérifient
  ...
  forment une base hilbertienne orthogonale de $L^2(\mathbb{R})$.
\end{mdframed}
