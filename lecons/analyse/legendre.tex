...
\begin{mdframed}[style=proofbar]
  ...
  De $u_n'=2nx\,u_n^{}/(x^2-1)$ on tire
  $(x^2-1)u_n'=2nx\,u_n$ ; en dérivant $n+1$ fois par la formule de Leibniz,
  on obtient $(1-x^2)P_n''-2xP_n'+n(n+1)P_n=0$. Sous forme
  \emph{auto-adjointe} (dite de Sturm--Liouville), cette équation s'écrit
  $\bigl[(1-x^2)P_n'\bigr]'=-n(n+1)P_n$~: $P_n$ est vecteur propre d'un
  opérateur auto-adjoint, point de vue systématisé dans la leçon sur les
  polynômes de Jacobi.
