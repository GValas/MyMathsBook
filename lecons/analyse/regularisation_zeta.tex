...
\lecontitle{La somme $1+2+3+\cdots=-\tfrac{1}{12}$}{Analyse réelle — Régularisation zêta et effet Casimir}
...
\begin{tcolorbox}[thmbox]
  ...
  l'égalité
  \[
    \boxed{\;1+2+3+4+\cdots \;\text{``}=\text{''}\; -\tfrac{1}{12}\;}
  \]
  ...
  \begin{itemize}
    \item \textit{Équation fonctionnelle.} Pour tout $s\in\mathbb{C}\setminus\{1\}$,
    \[
...
combinée à la régularisation d'Abel de $1-2+3-4+\cdots=\tfrac14$, redonne
$\zeta(-1)=-\tfrac1{12}$.
\end{ideepreuve}
...
\begin{mdframed}[style=proofbar]
  ...
  (au sens d'Abel) de $1-2+3-4+\cdots$ est donc $\tfrac14$, c'est-à-dire
  $\eta(-1)=\tfrac14$.
...
\begin{mdframed}[style=cexbar]
  ...
  \emph{régularisée}, pas la limite des sommes partielles. Un nombre positif de
  termes positifs ne peut donner un négatif.
