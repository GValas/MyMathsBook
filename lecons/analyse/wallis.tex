...
\begin{mdframed}[style=proofbar]
  ...
  On intègre par parties : $u = \sin^{n-1}t$, $v' = \sin t$ :
  \[
  ...
  \[
    \Wn\;\sim\;\sqrt{\frac{\pi}{2n}}. \hfill\blacksquare
  \]
\end{mdframed}
...
\begin{mdframed}[style=exbar]
  ...
  Les formules closes donnent $W_{2p}^2\sim\pi/(4p)$, ce qui implique,
  après développement de $(2p)!$ en termes de $(p!)^2$, la formule de
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item Montrer que $\displaystyle\sum_{n=0}^{+\infty}(-1)^n W_{2n+1}=\frac{\pi}{4}$.
