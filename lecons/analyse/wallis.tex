...
\begin{mdframed}[style=cexbar]
  ...
  $W_{m+n}\neq W_m\cdot W_n$ en général : ainsi $W_2 = \pi/4$ alors que
  $W_1\cdot W_1 = 1$. La relation de récurrence
  $\Wn = \frac{n-1}{n}W_{n-2}$ ne fait pas de $n\mapsto\Wn$ un
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    \item Calculer $\displaystyle\int_0^\pi\sin^7(t)\,\mathrm{d}t$ et
          ...
          (\textit{Indication}~: pour la seconde, les bornes ne permettent
          pas de se ramener à un $W_n$~; linéariser $\cos^4 t$.)
