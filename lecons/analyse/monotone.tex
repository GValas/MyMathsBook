...
\begin{mdframed}[style=exbar]
  ...
  r \cdot u_n < u_n$) et minorée par $0$. Le théorème garantit la
  convergence ; la limite est $\inf_n r^n = 0$.
  ...
  La suite définie pour $n \geq 1$ par $e_n = \left(1 + \frac{1}{n}\right)^n$ est croissante et majorée
...
\leconfooter{A.-L.\ Cauchy, \emph{Cours d'analyse} (1821)}
