...
\begin{tcolorbox}[thmbox]
  ...
  $\theta$, c'est-à-dire les fractions rationnelles de $\pi$ dont le cosinus
  ...
  \begin{itemize}
    ...
    \item \textit{Formules d'addition, duplication, bissection} — elles
      ...
      \]
    \item \textit{Racines d'un polynôme} — pour les angles « non constructibles
      par le compas seul à partir des précédents » (typiquement $\pi/5$), on
      écrit une relation polynomiale issue de $\cos(n\theta)$ et on la résout.
      Ainsi
      \[
...
\begin{mdframed}[style=cexbar]
  ...
  $\cos(2\pi/5)$, fait perdre le facteur d'échelle~: ce sont deux racines
  \emph{distinctes} de $4x^2-2x-1=0$… au signe et à l'indexation près.
\end{mdframed}
