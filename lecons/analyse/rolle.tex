...
Autrement dit, la dérivée s'annule au moins une fois entre $a$ et $b$.
(À ne pas confondre avec le théorème de Darboux, qui affirme que $f'$
vérifie la propriété de la valeur intermédiaire.)
...
\begin{mdframed}[style=cexbar]
  ...
  $f(x) = x$ sur $[0,1]$ : $f(0)\neq f(1)$, et pourtant $f'(x)=1$ ne
  s'annule jamais : la conclusion de Rolle est en défaut.
\end{mdframed}
