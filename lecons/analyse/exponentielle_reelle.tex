...
\begin{tcolorbox}[thmbox]
  ...
  \begin{enumerate}
    ...
    \]
    \item \textbf{Reste de Taylor :} pour tout $x \in \mathbb{R}$,
    \[
...
\begin{mdframed}[style=proofbar]
  ...
  \textit{(3).} Formule de Taylor avec reste de Lagrange, valable pour tout
  $x \in \mathbb{R}$ : comme $\exp^{(n+1)} = \exp$ est continue sur $\mathbb{R}$,
