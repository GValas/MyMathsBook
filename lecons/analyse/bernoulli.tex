...
\begin{tcolorbox}[thmbox]
  ...
  \begin{itemize}
    ...
    entiers $p\geq 0$ et $m\geq 1$ (avec la convention $0^{0}=1$),
    \[
      \sum_{k=0}^{m-1} k^{p}
...
\begin{mdframed}[style=proofbar]
  ...
  (avec la convention $0^{0}=1$ pour le terme $k=0$ lorsque $p=0$),
  \[
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item (Euler--Maclaurin) En appliquant la formule à $f(t)=\ln t$ sur
          ...
          en $1/(12n)$ ; Euler--Maclaurin ne détermine la constante additive
          qu'à une valeur près, que l'on identifie à $\tfrac{1}{2}\ln(2\pi)$
          grâce aux intégrales de Wallis (cf.\ leçon correspondante).
  \end{enumerate}
\end{mdframed}
