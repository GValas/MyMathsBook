...
$\int t^{\alpha}\,\mathrm{d}t = \tfrac{t^{\alpha+1}}{\alpha+1}$ couvre tous les
...
\begin{mdframed}[style=proofbar]
  ...
  (car $\int_1^2 \mathrm{d}t/t > 0$), on a $\ln(2^n)\to+\infty$. Puisque $\ln$ est
...
\begin{mdframed}[style=cexbar]
  ...
  $\ln(0)$ n'existe pas : l'intégrale $\int_0^1 \mathrm{d}t/t$ diverge (le pôle en
