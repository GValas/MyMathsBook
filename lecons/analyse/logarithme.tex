...
\lecontitle{Construction du logarithme népérien}{Analyse réelle — Fonctions élémentaires}
...
\begin{tcolorbox}[thmbox]
  ...
  \[
    ...
    x \longmapsto \int_1^x \frac{\dd t}{t}.
  \]
...
Parmi les primitives des fonctions puissances, la formule
$\int t^{\alpha}\dd t = \tfrac{t^{\alpha+1}}{\alpha+1}$ couvre tous les
exposants sauf $\alpha = -1$. La fonction $t\mapsto 1/t$, continue sur
$]0,+\infty[$, y admet pourtant des primitives : on choisit celle qui s'annule
en $1$. C'est cette primitive « manquante » que l'on baptise logarithme
népérien ; toutes ses propriétés se lisent alors directement sur l'intégrale
qui la définit.
...
$e \approx 2{,}718$. Pour tout $n \in \mathbb{Z}$, l'équation fonctionnelle
donne $\ln(e^n) = n$, ce qui justifie rétrospectivement la notation.
...
obtenues via $\ln(2^n)=n\ln 2$ et la croissance de $\ln$.
\end{ideepreuve}
...
\begin{mdframed}[style=proofbar]
  ...
  fondamental du calcul intégral\index{théorème fondamental de l'analyse},
  $\ln$ est dérivable et $\ln'(x) = 1/x > 0$. En particulier $\ln$ est
  strictement croissante. Comme $x\mapsto 1/x$ est $\mathcal{C}^\infty$ sur
  $\mathbb{R}_+^*$, $\ln$ est $\mathcal{C}^\infty$, avec
  ...
  (car $\int_1^2 \dd t/t > 0$), on a $\ln(2^n)\to+\infty$. Puisque $\ln$ est
...
\rubriq{Logarithmes de base quelconque}
Pour $a > 0$, $a \neq 1$, on définit le \emph{logarithme de base
$a$}\index{logarithme de base $a$} par
\[
  \log_a x = \frac{\ln x}{\ln a} \qquad (x > 0).
\]
Il vérifie la même équation fonctionnelle que $\ln$, dont il ne diffère que
par la normalisation $\log_a(a) = 1$ ; en particulier $\ln = \log_e$.
Les cas usuels sont le logarithme décimal $\log_{10}$ (ordres de grandeur,
pH, décibels) et le logarithme binaire $\log_2$ (informatique, théorie de
l'information).
...
\begin{mdframed}[style=exbar]
  ...
  \[
    \int_1^e \ln(t)\dd t = \bigl[t\ln(t)-t\bigr]_1^e = 1.
  \]

  \smallskip\noindent
  \textbf{4. Inégalité arithmético-géométrique.}
  Pour $a_1,\dots,a_n > 0$ : de $\ln(x)\leq x-1$, en notant
  $\mu = \dfrac{a_1+\cdots+a_n}{n}$ la moyenne
  arithmétique, puis en remplaçant $x$ par $a_i/\mu$ et en sommant
...
\begin{mdframed}[style=cexbar]
  ...
  $\ln(0)$ n'existe pas : l'intégrale $\int_0^1 \dd t/t$ diverge (le pôle en
  ...
  une divergence remarquablement lente (d'autres séries divergent plus
  lentement encore, comme $\sum 1/(n\ln n)$).
\end{mdframed}
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item Établir $\ln(1+x) = \displaystyle\int_0^x\!\frac{\dd t}{1+t}$
