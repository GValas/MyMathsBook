...
\begin{mdframed}[style=exbar]
  ...
  \[
    \frac{1}{\mu_n}\int_{-\varepsilon}^{\varepsilon}\mu_{n-1}\,{(1-t^2)}^{(n-1)/2}\,\mathrm{d}t
    = \frac{\mu_{n-1}}{\mu_n}\int_{-\varepsilon}^{\varepsilon}{(1-t^2)}^{(n-1)/2}\,\mathrm{d}t.
  \]
  ...
  volume se concentre près de l'équateur $\{x_1 = 0\}$.
