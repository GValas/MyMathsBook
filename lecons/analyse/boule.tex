...
\lecontitle{Volume de la boule en dimension $n$}{Analyse — Wallis, Fubini et géométrie en grande dimension}
...
On écrit $B_n(R)$ comme une pile de boules $(n{-}1)$-dimensionnelles :
\[
...
\begin{mdframed}[style=exbar]
  ...
  \]
  Pour $n=3$ : $\mathrm{Aire}(S^2(R)) = 4\pi R^2 = 3\mu_3 R^2$. ✓
