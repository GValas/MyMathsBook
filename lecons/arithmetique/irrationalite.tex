...
\begin{mdframed}[style=proofbar]
  ...
  \[
    N \leq \sum_{j=1}^{\infty} \frac{1}{(q+1)^{j}}
      = \frac{1}{q} \leq 1, \qquad\text{et même } N < 1 .
  \]

  \smallskip\noindent
  Ainsi $N$ est un entier strictement compris entre $0$ et $1$ : contradiction.
  Donc $e \notin \mathbb{Q}$. \hfill$\blacksquare$
\end{mdframed}
...
\noindent{\bfseries\color{counterred} Points de vigilance.}
