...
\begin{mdframed}[style=proofbar]
  ...
  \]
  l'inégalité étant \emph{stricte} dès que $k \geq q+2$. Par sommation de la
  série géométrique de raison $\frac{1}{q+1} < 1$, on en déduit
  \[
...
\begin{mdframed}[style=proofbar]
  ...
  Comme $\deg f_n = 2n$, on a $f_n^{(2n+2)} = 0$ ; en dérivant deux fois $F_n$,
  les dérivées intermédiaires se télescopent, et il ne subsiste que
  $F_n + F_n'' = f_n$. Alors
  \[
...
\begin{mdframed}[style=exbar]
  ...
  La méthode intégrale du § 2 (Hermite) s'adapte et montre que $e^r$ est
  irrationnel pour tout $r \in \mathbb{Q}^*$ (cf.\ exercice~2)~; le cas de
  $\sqrt{e}$ découle d'ailleurs directement du § 1 : si $\sqrt{e}$ était
  rationnel, $e = {(\sqrt{e})}^2$ le serait aussi.
...
\begin{mdframed}[style=cexbar]
  ...
  $\sqrt2$ est irrationnel (cf.\ la leçon sur le théorème fondamental de
  l'arithmétique) mais \emph{algébrique} (racine de $X^2 - 2$).
  ...
  moins l'est : s'ils étaient tous deux rationnels, $e$ et $\pi$, racines de
  $X^2 - (e+\pi)X + e\pi \in \mathbb{Q}[X]$, seraient algébriques —
  contredisant leur transcendance (complément~3).
\end{mdframed}
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item Montrer que $\cos(1)$ est irrationnel. \emph{Indication :} si
          $\cos 1 = p/q$, multiplier
          $\cos 1 = \sum_{k=0}^{\infty} \frac{(-1)^k}{(2k)!}$ par $(2q)!$ et
          encadrer strictement la queue grâce au critère des séries alternées.
    \item Montrer que $\pi^2$ est irrationnel (variante de Niven avec
          $\int_0^1 f_n(x)\sin(\pi x)\,\mathrm{d}x$, où
          $f_n(x)=x^n{(1-x)}^n/n!$ et $\pi^2 = a/b$).
  \end{enumerate}
\end{mdframed}
