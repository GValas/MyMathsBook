...
\begin{tcolorbox}[thmbox]
  ...
  \textit{Tout entier $n \geq 2$ s'écrit de façon \textbf{unique} sous la forme}
  \[
...
\begin{tcolorbox}[thmbox]
  ...
  \begin{enumerate}
    \item $\pgcd(a,b) = \prod p_i^{\min(\alpha_i,\beta_i)}$,
          $\;\ppcm(a,b) = \prod p_i^{\max(\alpha_i,\beta_i)}$.
    \item $\pgcd(a,b) \cdot \ppcm(a,b) = ab$.
...
\begin{mdframed}[style=cexbar]
  \textbf{$N = p_1 p_2 \cdots p_k + 1$ n'est pas toujours premier.}\enspace%
  Dans la preuve d'Euclide, $N$ admet un facteur premier hors de la liste,
  mais n'est pas lui-même nécessairement premier :
