...
est, on l'admet, de Cauchy dans $\mathbb{Q}$ : elle converge en effet vers $\sqrt{2}$,
qui n'appartient pas à $\mathbb{Q}$. Cette incomplétude motive la construction de $\mathbb{R}$.
