...
\begin{significationintuitive}
  Les trois axiomes capturent l'image d'une file infinie sans répétition.
  P1 affirme que $0$ est un véritable point de départ : rien ne pointe vers lui,
  la file a un début. P2 interdit à deux entiers distincts d'avoir le même
  successeur : la file ne fusionne ni ne se referme sur elle-même (sans P1 ni P2,
  $S$ pourrait boucler sur un cycle). P3 (récurrence) interdit enfin tout élément
  «\,parasite\,» extérieur à la chaîne $0, S(0), S(S(0)), \ldots$ : en partant de
  $0$ et en itérant $S$, on atteint \emph{tout} $\mathbb{N}$.
...
\begin{mdframed}[style=proofbar]
  ...
  Par exemple, $n + m = m + n$ se montre par récurrence, après avoir établi
  les lemmes auxiliaires $0 + n = n$ et $S(m) + n = S(m + n)$ ; ceux-ci ne
  découlent pas immédiatement de la définition, qui ne récurre que sur le
  second argument.
