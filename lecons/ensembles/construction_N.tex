...
\lecontitle{Construction de $\mathbb{N}$}{Théorie des ensembles — Axiomes de Peano}
...
\begin{tcolorbox}[thmbox]
  ...
  \begin{enumerate}
    \item[\textbf{P1.}] $0$ n'est le successeur d'aucun entier : $S$ est non surjective sur $\{0\}$.
...
\begin{mdframed}[style=exbar]
  ...
  Cela résulte de P3 appliqué à $B = \mathbb{N} \setminus A$ : si $B \neq \mathbb{N}$,
  $B$ ne peut contenir tous les successeurs, donc $A$ a un minimum.
