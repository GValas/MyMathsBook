...
\lecontitle{Construction de $\mathbb{R}$}{Théorie des ensembles — Complétion de $\mathbb{Q}$}
...
\begin{mdframed}[style=proofbar]
  ...
  Construisons $y \in [0,1]$ différent de chaque $x_n$ : si le $n$-ième décimale
  de $x_n$ est $d$, on pose le $n$-ième décimale de $y$ égal à $d+1 \pmod{10}$.
  Alors $y \neq x_n$ pour tout $n$ : contradiction. \hfill$\blacksquare$
\end{mdframed}
