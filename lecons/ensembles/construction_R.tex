...
\begin{mdframed}[style=proofbar]
  ...
  positifs des deux coupures (l'ensemble obtenu est bien fermé vers le bas, donc une
  coupure). On étend ensuite à $\alpha, \beta$ quelconques par les règles des signes :
...
\begin{mdframed}[style=proofbar]
  ...
  entraîne $a$~fortiori la non-dénombrabilité de $\mathbb{R}$. Supposons donc
