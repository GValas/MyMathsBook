...
(elle n'en a que si $n \leq m$). On veut construire le plus petit
\emph{groupe abélien} contenant le monoïde $(\mathbb{N}, +)$ ; on constatera
que la multiplication s'y prolonge et en fait un anneau.
