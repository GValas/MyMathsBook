...
\begin{mdframed}[style=proofbar]
  ...
  Le polynôme caractéristique $\chi_f \in \mathbb{R}[X]$ est de degré
  $n \geq 1$. Par le théorème de d'Alembert-Gauss, $\chi_f$ est scindé sur
  $\mathbb{C}$ ; ses racines complexes étant toutes réelles (Lemme 1), il
...
\begin{mdframed}[style=exbar]
  ...
  est autoadjoint (opérateur non borné : son autoadjonction demande de
  préciser le domaine, cf.\ la mise en garde « Dimension infinie »
  ci-dessous) ; ses vecteurs propres sont les fonctions $x\mapsto\sin(nx)$,
  $n\geq 1$, base de Fourier en sinus.
\end{mdframed}
...
\begin{mdframed}[style=cexbar]
  ...
  \smallskip\noindent
  \textbf{La condition $A^*=A$ ne se relâche pas en « normale ».}\enspace%
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item Soit $f$ autoadjoint sur un espace euclidien. Montrer que
          $\|f\| = \max\{|\lambda|,\;\lambda\text{ v.p. de }f\}$, où
          $\|f\| = \sup_{\|x\|=1}\|f(x)\|$ désigne la norme d'opérateur
