...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item (Théorème de Wedderburn) Tout corps gauche (anneau à division) fini
          est commutatif. Admettre ce résultat et en déduire qu'un corps gauche
          non commutatif est nécessairement infini.
  \end{enumerate}
\end{mdframed}
