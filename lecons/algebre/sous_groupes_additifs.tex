...
\begin{tcolorbox}[thmbox]
  ...
  \end{enumerate}
  Plus précisément, en posant $a = \inf\bigl(G \cap \,]0,+\infty[\,\bigr)$ (avec
  $a = +\infty$ si $G = \{0\}$), on est dans le cas monogène lorsque $a > 0$ (ou
  $G=\{0\}$), et dans le cas dense lorsque $a = 0$.
\end{tcolorbox}
...
\begin{mdframed}[style=proofbar]
  ...
  \]
  ce qui contredit la définition de $a$ comme \emph{plus petit} élément
  $> 0$ approché. Donc $a \in G$.
  ...
  alors $a$ et $b$ sont le plus petit élément $>0$ commun (ou $0$), d'où $a = b$ :
...
\begin{mdframed}[style=proofbar]
  ...
  alors $m + n\alpha = (mq + np)/q \in \tfrac{1}{q}\mathbb{Z}$, et par Bézout
  $\tfrac1q\mathbb{Z} \subseteq G$ ; donc $G = \tfrac1q\mathbb{Z}$ est monogène,
  \emph{non} dense.
  ...
  \smallskip\noindent
  Enfin $\{n\alpha\} = n\alpha - \lfloor n\alpha\rfloor$ parcourt $G \cap [0,1[$ ;
  la densité de $G$ dans $\mathbb{R}$ équivaut à celle de $(\{n\alpha\})$ dans $[0,1]$.
  \hfill$\blacksquare$
\end{mdframed}
...
\begin{mdframed}[style=exbar]
  ...
  Comme $\pi \notin \mathbb{Q}$, $2\pi$ est irrationnel, donc
...
\noindent{\bfseries\color{counterred} Contre-exemples et points de vigilance.}
