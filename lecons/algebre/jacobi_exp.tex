...
\begin{tcolorbox}[thmbox]
  \begin{enumerate}
    ...
    \item \textbf{Inversibilité de $e^A$.}\enspace{}
          $\det(e^A) = e^{\mathrm{tr}(A)} \neq 0$ redonne que $e^A$ est
          inversible (l'identité ${(e^A)}^{-1} = e^{-A}$ venant, elle,
          de $e^A e^{-A} = e^0 = I$, car $A$ et $-A$ commutent).
...
\begin{mdframed}[style=cexbar]
  ...
  \smallskip\noindent
  \textbf{La formule de Liouville vaut pour $A(t)$ \emph{variable}, pas seulement constante.}\enspace{}
