...
\begin{mdframed}[style=proofbar]
  ...
  $\langle x - \lambda_0 y,\, x - \lambda_0 y\rangle = 0$ ; par définie positivité,
  cela signifie $x = \lambda_0 y$, donc $x$ et $y$ sont colinéaires.
...
\begin{mdframed}[style=proofbar]
  Soit $(e_1,\ldots,e_p)$ une base orthonormée de $F$ (obtenue par Gram-Schmidt,
