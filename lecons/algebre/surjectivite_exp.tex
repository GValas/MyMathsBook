...
\begin{tcolorbox}[thmbox]
  ...
  \begin{enumerate}
    ...
    \item \textbf{Sur $\mathbb{R}$.}\enspace
          ...
          est \emph{non surjective} pour tout $n \geq 1$
          (et dès $n \geq 2$, certaines matrices de déterminant
          strictement positif échappent même à l'image).
  \end{enumerate}
\end{tcolorbox}
...
\begin{tcolorbox}[thmbox]
  ...
  \begin{enumerate}
    ...
    \item $\exp$ n'est pas injective~: $e^A = e^{A + 2\pi i\,I_n}$.
          Plus généralement, si $A$ est diagonalisable, $A = Q\,\mathrm{diag}(a_1,\dots,a_n)\,Q^{-1}$,
          alors toute matrice $B = Q\,\mathrm{diag}(a_1 + 2\pi i k_1,\dots,a_n + 2\pi i k_n)\,Q^{-1}$
          avec $k_1,\dots,k_n \in \mathbb{Z}$ vérifie encore $e^B = e^A$.
    \item L'image de $\exp : \mathcal{M}_n(\mathbb{R}) \to \mathrm{GL}_n(\mathbb{R})$
          est contenue dans $\mathrm{GL}_n^+(\mathbb{R}) = \{M \in \mathrm{GL}_n(\mathbb{R})
...
\begin{mdframed}[style=cexbar]
  ...
  l'ensemble $\{A \in \mathcal{M}_n(\mathbb{C}) \mid e^A = I_n\}$ des antécédents
  de $I_n$ est infini. Ce sont exactement les matrices diagonalisables dont
  toutes les valeurs propres appartiennent à $2\pi i\,\mathbb{Z}$, c'est-à-dire
  les conjuguées $P\,\mathrm{diag}(2\pi i k_1,\dots,2\pi i k_n)\,P^{-1}$ avec
  $P \in \mathrm{GL}_n(\mathbb{C})$ et $k_1,\dots,k_n \in \mathbb{Z}$.
  ...
  \smallskip\noindent
  \textbf{Produit d'exponentielles.}\enspace
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    \item Montrer que $-I_n$ est dans l'image de $\exp: \mathcal{M}_n(\mathbb{R})
          ...
          (\textit{Indication~:} pour $n$ pair, utiliser des blocs de rotation~;
    ...
    \item Calculer explicitement $A \in \mathcal{M}_2(\mathbb{C})$ tel que
          ...
          (\textit{Indication~:} poser $A = \pi i\,I + B$, de sorte que
          $e^A = e^{\pi i}\,e^B = -e^B$~; il faut donc
          $e^B = \bigl(\begin{smallmatrix}1&-1\\0&1\end{smallmatrix}\bigr)$,
          obtenu avec $B = \bigl(\begin{smallmatrix}0&-1\\0&0\end{smallmatrix}\bigr)$
          nilpotent, dont l'exponentielle est unipotente.)

    \item Soit $M \in \mathrm{GL}_n(\mathbb{R})$. Montrer que $M$ est dans
          l'image de $\exp : \mathcal{M}_n(\mathbb{R}) \to \mathrm{GL}_n(\mathbb{R})$
          si et seulement si, dans la réduction de Jordan complexe de $M$,
          chaque bloc de Jordan associé à une valeur propre réelle
          \emph{strictement négative} apparaît un nombre \emph{pair} de fois
          (à taille fixée). (\textit{Indication~:} les blocs de valeur propre
          réelle positive ou complexe non réelle se traitent par logarithme
          réel~; l'obstruction du §\,1 vient des blocs de valeur propre
          négative en nombre impair.)
    ...
    \item Montrer que pour tout $M \in \mathrm{GL}_n^+(\mathbb{R})$ il existe
          ...
          (\textit{Indication~:} $\mathrm{GL}_n^+(\mathbb{R})$ est un groupe
          de Lie connexe, donc engendré par tout voisinage de l'identité~;
          l'image de $\exp$ contient un tel voisinage car $\exp$ est un
          difféomorphisme local en $0$. On peut aussi se ramener bloc par
          bloc en utilisant $-I_2 = e^{\pi J}$,
          $J = \bigl(\begin{smallmatrix}0&-1\\1&0\end{smallmatrix}\bigr)$,
          pour fabriquer les valeurs propres réelles négatives par paires.)
