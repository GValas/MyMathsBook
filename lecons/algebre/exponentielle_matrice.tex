...
\begin{mdframed}[style=proofbar]
  ...
  \]
  (formule admise ici~; cf.\ la leçon consacrée à la formule
  $\det(e^A) = e^{\mathrm{tr}(A)}$, qui en propose une preuve en exercice et
  donne un argument autonome par équation fonctionnelle).
...
\begin{mdframed}[style=cexbar]
  ...
  $AB\neq BA$ et le calcul est immédiat~: $A^2=B^2=0$ donne
  $e^Ae^B = (I+A)(I+B) = \begin{pmatrix}2&1\\1&1\end{pmatrix}$, tandis que
  ${(A+B)}^2 = I$ donne
  $e^{A+B} = \cosh(1)\,I + \sinh(1)\,(A+B)
