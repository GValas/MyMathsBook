...
\begin{mdframed}[style=proofbar]
  ...
  \]
  La série converge absolument ; $\mathcal{M}_n(\mathbb{K})$ étant complet,
  elle converge. \hfill$\blacksquare$
\end{mdframed}
...
\begin{mdframed}[style=proofbar]
  ...
  Alors, en intervertissant les sommes (convergence absolue) :
  \[
...
\begin{mdframed}[style=proofbar]
  ...
  $f(0)=1$ et, en dérivant :
  $f'(t) = \mathrm{tr}(A)\,\det(e^{tA}) = \mathrm{tr}(A)\,f(t)$.
...
Toute matrice $A$ s'écrit $A = D + N$ avec $D$ diagonalisable, $N$ nilpotente
et $DN = ND$. Comme $D$ et $N$ commutent :
\[
  e^A = e^D \cdot e^N,
\]
...
\begin{mdframed}[style=exbar]
  ...
  $A = \theta\begin{pmatrix}0&-1\\1&0\end{pmatrix}$.
  Valeurs propres complexes $\pm i\theta$. En développant directement :
  \[
...
\]
Les parties réelles $\mathrm{Re}(\lambda_i)$ gouvernent la stabilité :
$X(t)\to 0$ si et seulement si tous les $\mathrm{Re}(\lambda_i) < 0$.
...
\leconfooter{G.\ Peano (1888) — M.\ Fr\'echet (1905) — omniprésente en théorie des systèmes}
