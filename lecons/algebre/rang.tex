...
\begin{tcolorbox}[thmbox]
  \textbf{Théorème du rang} (\emph{rank--nullity theorem} en anglais)\textbf{.}\enspace%
...
\begin{mdframed}[style=proofbar]
  ...
  base de $\ker f$, il existe des scalaires $\lambda_1,\ldots,\lambda_p$
  tels que
  \[
  ...
  \smallskip
  \textit{Cas dégénérés.}
  L'argument vaut encore pour $p = 0$ ($f$ injective~: la base de $\ker f$ est
  la famille vide) et pour $p = n$ ($f = 0$~: la famille des images est vide et
  $\mathrm{Im}\,f = \{0\}$), avec les conventions usuelles sur la famille vide,
  libre et engendrant $\{0\}$.
...
\begin{mdframed}[style=cexbar]
  ...
  \smallskip\noindent
  \textbf{En dimension infinie, le corollaire \og{}injectif $\Leftrightarrow$
  surjectif\fg{} tombe en défaut.}\enspace%
  Sur $E = \mathbb{K}[X]$, l'application $P \mapsto XP$ est injective mais pas
  surjective (son image est l'ensemble des polynômes sans terme constant),
  tandis que la dérivation $P \mapsto P'$ est surjective mais pas injective
  (son noyau est la droite des polynômes constants). Le théorème du rang, lui,
  ne s'applique tout simplement plus~: $\dim E$ n'est pas finie et l'égalité
  n'a plus de sens.

  \smallskip\noindent
  \textbf{$\mathrm{rg}(A) = \mathrm{rg}(A^T)$, mais $\ker A \neq \ker A^T$ en général.}\enspace%
  Le rang-ligne et le rang-colonne coïncident. En revanche, si $m \neq n$, les
  noyaux de $A$ et $A^T$ vivent dans des espaces différents ($\mathbb{K}^n$ et
  $\mathbb{K}^m$) et n'ont pas la même dimension ($n-r$ contre $m-r$).
  Même pour une matrice carrée, ils peuvent différer~: pour
  $A = \begin{pmatrix}0&1\\0&0\end{pmatrix}$, on a
  $\ker A = \mathrm{Vect}(e_1)$ mais $\ker A^T = \mathrm{Vect}(e_2)$.
\end{mdframed}
