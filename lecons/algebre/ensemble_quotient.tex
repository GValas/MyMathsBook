...
\begin{mdframed}[style=exbar]
  ...
  Soit $n \geq 1$ un entier. Sur $\mathbb{Z}$, poser $a \equiv b \pmod{n}$ si $n \mid (b-a)$.
  ...
  Soit $E$ un $\mathbb{K}$-espace vectoriel et $F$ un sous-espace de $E$.
  On pose $x \sim y$ si $x-y \in F$.
  ...
  (formule de la dimension : $\dim(E/F)$ est la
  \emph{codimension}\index{codimension} de $F$ dans $E$).
...
\begin{mdframed}[style=cexbar]
  ...
  À l'inverse, la congruence modulo $n$ est compatible avec l'addition et la
  multiplication de $\mathbb{Z}$, ce qui fonde la structure d'anneau de
  $\mathbb{Z}/n\mathbb{Z}$ affirmée au §\,3.
...
\begin{mdframed}[style=exobar]
  \begin{enumerate}
    ...
    \item Soit $f : E \to F$. Montrer que la relation $x\sim_f y \Leftrightarrow f(x)=f(y)$
          ...
          $\bar{f} : E/{\sim_f} \to F$ est injective. En notant
          $\tilde{f} : E/{\sim_f} \to \mathrm{Im}(f)$ sa corestriction
          (bijective), en déduire la décomposition canonique
          $f = \iota \circ \tilde{f} \circ \pi$
          (surjection--bijection--injection), où $\iota$ est l'injection
    ...
    \item (Premier théorème d'isomorphisme) Soit $\varphi : G \to H$ un homomorphisme de groupes.
          Montrer que $G/\ker\varphi \cong \mathrm{Im}(\varphi)$.
          \emph{Indication : on vérifiera d'abord que $\ker\varphi$ est un
          sous-groupe distingué de $G$, ce qui munit $G/\ker\varphi$ d'une
          structure de groupe.}
  \end{enumerate}
\end{mdframed}
