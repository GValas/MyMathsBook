...
\begin{tcolorbox}[thmbox]
  ...
  L'argument principal $\arg(z) \in \left(-\pi,\pi\right]$ est l'unique représentant dans cet intervalle. % chktex 9
...
\begin{mdframed}[style=proofbar]
  On définit $\exp(z) = \sum_{k=0}^\infty z^k/k!$ sur $\mathbb{C}$ (série absolument convergente). % chktex 40
...
\begin{tcolorbox}[thmbox]
  \textbf{Théorème fondamental de l'algèbre (d'Alembert-Gauss).}%
  \index{théorème fondamental de l'algèbre}\enspace{}
