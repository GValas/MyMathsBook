...
\begin{mdframed}[style=proofbar]
  ...
  \textit{Transitivité.} Soit $(a,b)\sim(c,d)$ et $(c,d)\sim(e,f)$, avec
  $f\neq 0$. Supposons donc $ad=bc$ et $cf=de$.
  On veut $af=be$. On a $adf = bcf = bde$,
  donc $d(af-be)=0$. Comme $d\neq 0$ et $A$ est \emph{intègre}, $af=be$. $\blacksquare$
\end{mdframed}
...
\begin{mdframed}[style=proofbar]
  ...
  \Rightarrow a\cdot 1 = a'\cdot 1 \Rightarrow a=a'$. $\blacksquare$
\end{mdframed}
...
\begin{mdframed}[style=cexbar]
  ...
  $(a,b)\sim(c,d)\iff ad\equiv bc\pmod 6$, on a
