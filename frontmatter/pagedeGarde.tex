...
\begin{flushright}
  ...
  {\fontsize{13}{18}\selectfont\itshape\color{navyblue!60}
    ...
    et exercices niveau classes préparatoires}\\[3cm]

  \noindent\textcolor{navyblue!25}{\rule{12cm}{0.5pt}}\\[0.8cm]

  {\large\color{navyblue!70}
    Analyse réelle \textcolor{goldaccent}{·}
    Structures algébriques \textcolor{goldaccent}{·}
    Arithmétique\\[6pt]
    Combinatoire \textcolor{goldaccent}{·}
    Topologie \textcolor{goldaccent}{·}
    Algèbre linéaire}\\[2.5cm]

  {\normalsize\color{navyblue!50} \today\ — \currenttime}
\end{flushright}
